...
In order to search, exchange, and abstract useful information from distributed sources in an efficient manner, there are at least the following two development trends that we can come up with naturally:
\begin{itemize}
