...
\vspace{0.1in}
\noindent \textbf{Update and Remove Document}
\vspace{0.1in}
...
To remove a document, use \verb|deleteOne({<query>})| and \verb|deleteMany({<query>})|.

\vspace{0.1in}
\noindent \textbf{Advanced Features}
\vspace{0.1in}
...
Data in MongoDB can be exported or imported from files, such as JSON files.
