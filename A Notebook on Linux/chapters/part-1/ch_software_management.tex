...
\begin{itemize}
	\item RPM
	\item \mync{Debian Package Manager}[DEB]
\end{itemize}
...
Due to the drawbacks of \verb|rpm| mentioned earlier, other tools have been developed to handle package upstream repositories and dependencies more conveniently. These tools are YUM and its next generation \mync{Dandified YUM}[DNF], with their corresponding commands \verb|yum| and \verb|dnf| respectively.
