...
{Linux \myabb{command line interface}{CLI}, usually known as the ``\mync{shell}'' (also known as ``\mync{terminal}''), is the most available, flexible and powerful tool for the users and programs to interact with the OS and perform certain actions.
