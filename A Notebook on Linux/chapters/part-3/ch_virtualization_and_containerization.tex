...
\begin{enumerate}[(1)]
  ...
  \item Copy more files after package installation. (Create \verb|.dockerignore| file and specifies the files you would rather not to be copied to the container, to prevent any overwriting to the earlier installed packages.)
...
\section{Multi-Container Ochestration}
